...
## ====================================================================================================================================================#
## ====================================================================================================================================================#
## ==============================================IMITATE_EPISODES.PY USING MPS SHADERS FOR MACBOOK PRO M3==============================================#
## ====================================================================================================================================================#
## ====================================================================================================================================================#
...
def main(args):
    ...
    best_ckpt_info = train_bc(train_dataloader, val_dataloader, config, device)
    best_epoch, min_val_loss, best_state_dict = best_ckpt_info
...
def make_policy(policy_class, policy_config, device):
    if policy_class == 'ACT':
        ...
        policy = CNNMLPPolicy(policy_config).to(device)
    else:
        raise NotImplementedError
    return policy
...
def train_bc(train_dataloader, val_dataloader, config, device):
    num_epochs = config['num_epochs']
    ckpt_dir = config['ckpt_dir']
    seed = config['seed']
    policy_class = config['policy_class']
